...
export const getDashboardStats = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has("admin-stats"))
        ...
        const categoriesCountPromise = categories.map((curr_category) => Product.countDocuments({ "category": curr_category }));
...
// Function to get line charts data
export const getLineCharts = TryCatch(async (req, res) => {
    // Your implementation here
});

// Function to get pie charts data
